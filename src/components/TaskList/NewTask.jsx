...
const NewTask = ({ data }) => {
  return (
    <div className="bg-green-400 p-4 rounded-lg shadow-md w-full sm:w-[250px] h-auto flex flex-col justify-between max-w-[95%] mx-auto">
      {/* Task Header */}
      ...
      <div className="flex flex-wrap justify-center mt-auto space-x-2 gap-y-2">
        <button className="bg-red-500 hover:bg-red-600 text-white text-sm px-3 py-2 rounded-lg transition duration-200">
          Accepted
        </button>
      </div>
    </div>
