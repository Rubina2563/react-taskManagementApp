...
const TaskListNumber = ({ data }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-6 bg-pink-100 py-6">
      {/* Task Stats */}
      <div className="flex flex-wrap gap-3 justify-center">
        {stats.map((stat, idx) => (
          <div
            key={idx}
            className={`flex flex-col items-center justify-center w-32 h-20 rounded-md text-white ${stat.color}`}
          style={{
